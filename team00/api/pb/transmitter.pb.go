...
func (x *TransmitterResponse) Reset() {
	*x = TransmitterResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *TransmitterResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TransmitterResponse) ProtoMessage() {}

func (x *TransmitterResponse) ProtoReflect() protoreflect.Message {
	mi := &file_transmitter_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TransmitterResponse.ProtoReflect.Descriptor instead.
func (*TransmitterResponse) Descriptor() ([]byte, []int) {
	return file_transmitter_proto_rawDescGZIP(), []int{1}
}

func (x *TransmitterResponse) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *TransmitterResponse) GetFrequency() float64 {
	if x != nil {
		return x.Frequency
	}
	return 0
...
func (x *TransmitterResponse) GetTimestamp() *timestamppb.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
var file_transmitter_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x14, 0x0a, 0x12, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x6d, 0x69, 0x74,
	0x74, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x8c, 0x01, 0x0a, 0x13, 0x54,
	0x72, 0x61, 0x6e, 0x73, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x32, 0x48, 0x0a, 0x0b, 0x54, 0x72, 0x61,
	0x6e, 0x73, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x72, 0x12, 0x39, 0x0a, 0x08, 0x54, 0x72, 0x61, 0x6e,
	0x73, 0x6d, 0x69, 0x74, 0x12, 0x13, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x6d, 0x69, 0x74, 0x74,
	0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x54, 0x72, 0x61, 0x6e,
	0x73, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
...
var file_transmitter_proto_goTypes = []interface{}{
	(*TransmitterRequest)(nil),    // 0: TransmitterRequest
	(*TransmitterResponse)(nil),   // 1: TransmitterResponse
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_transmitter_proto_depIdxs = []int32{
	2, // 0: TransmitterResponse.timestamp:type_name -> google.protobuf.Timestamp
	0, // 1: Transmitter.Transmit:input_type -> TransmitterRequest
	1, // 2: Transmitter.Transmit:output_type -> TransmitterResponse
...
func file_transmitter_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_transmitter_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TransmitterResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
